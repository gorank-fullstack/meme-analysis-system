...
// import { Option } from "@/constants/filters"; // Option = { value: string, label: string }
import {FilterConditionProps} from "@/interface/filters";
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <div className="flex-1 min-w-[180px]">
          ...
          <select
            ...
            onChange={(e: ChangeEvent<HTMLSelectElement>) =>
              onUpdate("timeFrame", e.target.value)
            }
          >
